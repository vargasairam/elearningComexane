<section class="content_global">
    ...
    <a href="?seccion=ondemand&accion=modulo<?= $numero ?>" class="btn btn-secondary btn_back mt-3 btn-sm"><i class="ri-arrow-left-line ri-lg"></i></a>
    <div class="content_ondemand">
        <div class="drawer_video_live">
            <div class="box_info_video_live mt-2 mb-4">
                <div class="c_primary mb-1">
                    <span class="badge text-bg-success fw-normal">Módulo <?= $numero ?></span>
                </div>
                <h3 class="fw-semibold mb-1"><?php echo $video->tema; ?></h3>
                <div>
                    <span>
