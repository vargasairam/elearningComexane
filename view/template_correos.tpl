            ...
            <tr bgcolor="#F1F2F7">
                <td align="center" bgcolor="#F1F2F7" valign="top" width="100%">
                    ...
                    <table class="container" align="center" border="0" cellpadding="0" cellspacing="0" width="600">
                        <tbody>
                            <tr bgcolor="{COLOR}"><td height="15"></td></tr>
                        ...
                        <tr bgcolor="{COLOR}"><td height="10"></td></tr>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <a href="" style="display: block;">
                                                             <img  style="display: block;width: 100%" width="600" src="https://curso-ameh.com/imgs/BANNER-CURSO-HBE-2026.jpg" >
                                                         </a>
                                                     </td>
                                                 </tr>
                                             </tbody>
                     ...
                     <tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td  align="justify" style="color: #484848; font-size: 16px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;">
                                                                        Sin mas por el momento le enviamos un gran saludo.<br>
                                                                    </td>
                                                                </tr>
                        ...
                        <tr>
                            <td  style="color: #939393; font-size: 11px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" class="prefooter-subheader" align="center">
                                <span style="color: #{COLOR}">Direcci&oacute;n:</span>   {DIRECCION}. &nbsp;&nbsp;&nbsp;   <span style="color: #{COLOR}"><br>Telefono:</span>  {TELEFONO}&nbsp;&nbsp;&nbsp;<span style="color: #{COLOR}">Email :</span>  {EMAIL_CONTACTO}
                            </td>
                        </tr>
                        ...
                        <tbody>
                            ...
                            <tr bgcolor="{COLOR}">
                                <td  style="color: #fff; font-size: 10px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;" align="center">
                                    ...
                                    {PREFIJO} &copy; Copyright  {ANIO}. <br>Powered by <a href="https://jc-innovation.com">JC Innovation</a>
