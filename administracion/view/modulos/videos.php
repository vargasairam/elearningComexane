<?php
    $from = isset($_GET['accion']) ? $_GET['accion'] : '';
    switch ($from) {
        case 'videos':
            $flecha_back = '<a href="./?seccion=modulos&id_curso='.$_GET['id_curso'].'" class="btn add-new btn-light" role="button">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="exampleModalLabel1">Subir video</h3>
