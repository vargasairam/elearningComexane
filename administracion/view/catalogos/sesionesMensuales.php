            ...
            <div>
                <div class="card-header">
                    <div class="row m-3 my-0 justify-content-between">
                        ...
                        <div class="d-md-flex justify-content-between align-items-center dt-layout-end col-md-auto">
                            <button class="btn btn-iconos add-new" tabindex="0" aria-controls="tb_empresas" type="button" data-bs-toggle="modal" data-bs-target="#modal_insertar"><span><span class="d-flex align-items-center gap-2"><i class="fas fa-plus"></i> <span class="d-none d-sm-inline-block">Agregar sesión</span></span></span></button>
                        </div>
                    </div>                
                </div>
                <div class="card-body">
                    ...
                    <div class="card-datatable">
                        <table id="tb_sesionesMensuales" class="datatables-users table">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Agregar sesión mensual</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="add-new-user pt-0" id="addConferencia" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6 mb-4">
                                <label class="form-label">Hora inicio <span class='obligatorio'>*</span></label>
                                <select name="h_inicio" class="form-control" required>
                                    <?php for($i = 0; $i < 24; $i++): ?>
                            ...
                            <div class="col-6 mb-4">
                                <label class="form-label">Hora fin <span class='obligatorio'>*</span></label>
                                <select name="h_fin" class="form-control" required>
                                    <?php for($i = 0; $i < 24; $i++): ?>
                                        <option value="<?= sprintf('%02d:00', $i) ?>">
                                            <?= sprintf('%02d:00', $i) ?>
                                        </option>
                            ...
                            <div class="col-8 mb-4">
                                <label class="form-label">Póster de la sesión <span class='obligatorio'>*</span><small>(Debe ser una imagen .jpg, .png o .jpeg)</small></label>
                                <input type="file" name="poster_sesion" class="form-control" placeholder="Ingrese el póster de la sesión" accept=".jpg,.png,.jpeg" required>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form class="add-new-user pt-0" id="updateConferencia">
                    ...
                    <div class="row">
                            ...
                            <div class="col-6 mb-4">
                                <label class="form-label">Hora inicio <span class='obligatorio'>*</span></label>
                                <select name="h_inicio" id="h_inicio" class="form-control" required>
                                    <?php for($i = 0; $i < 24; $i++): ?>
                                        <option value="<?= sprintf('%02d:00', $i) ?>">
                                            <?= sprintf('%02d:00', $i) ?>
                                        </option>
                            ...
                            <div class="col-6 mb-4">
                                <label class="form-label">Hora fin <span class='obligatorio'>*</span></label>
                                <select name="h_fin" id="h_fin" class="form-control" required>
                                    <?php for($i = 0; $i < 24; $i++): ?>
                                        <option value="<?= sprintf('%02d:00', $i) ?>">
                                            <?= sprintf('%02d:00', $i) ?>
                                        </option>
                            ...
                            <div class="col-8 mb-4">
                                <label class="form-label">Póster de la sesión <small>(Debe ser una imagen .jpg, .png o .jpeg)</small></label>
                                <input type="file" name="poster_sesion" class="form-control" accept=".jpg,.png,.jpeg">
...
<?php
    $scripts_js = [
        "js" => [
            ...
            "js/Catalogos/sesionesMensuales.js"
        ]
    ];
?>