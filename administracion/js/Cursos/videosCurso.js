...
var videosCurso = $('#tb_videosCurso').DataTable({
    ...
    ajax: {
        url: `${BASE_URL}/administracion/controllers/cursos.php?accion=getVideosCurso`,
        type: "post",
        data: {
            id_curso: id_curso
        }
        ...
        { 
            ...
            render: function(data, type, row, meta) {
                return  `<div class="btn-group mb-3" role="group" aria-label="Default button group">
                    ...
                    <button class="btn btn-outline-secondary px-2 me-2 ver-portada" title="Ver portada" data-video="${row.id}"><i class="fa-solid fa-image"></i></button>   
                </div> `
